...
parser = argparse.ArgumentParser(description="Convert monthly rx1day index to annual rx1day index")
parser.add_argument("origin", help="input: monthly rx1day netCDF file")
parser.add_argument("destination", help="output: annual rx1day netCDF file")
